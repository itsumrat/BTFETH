  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-1">
        ...
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('plans')); ?>">Plans</a></li>
        <?php if(auth()->guard()->check()): ?>
          <?php if(auth()->user()->is_admin): ?>
            <li class="nav-item ms-lg-2"><a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('admin.dashboard')); ?>">Admin Panel</a></li>
          <?php else: ?>
            <li class="nav-item ms-lg-2"><a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('dashboard')); ?>">Dashboard</a></li>
          <?php endif; ?>
        ...
        <?php else: ?>
          <li class="nav-item ms-lg-2"><a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('login')); ?>">Login</a></li>
          <li class="nav-item ms-1"><a class="btn btn-primary btn-sm" href="<?php echo e(route('register')); ?>">Get Started</a></li>
        <?php endif; ?>
      </ul>
    </div>
  </div>
    ...
    <div class="row align-items-center g-5">
      <div class="col-lg-6 fade-up">
        ...
        <div class="d-flex gap-3 flex-wrap">
          ...
          <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg">Create Account</a>
          <?php endif; ?>
          <a href="<?php echo e(route('about')); ?>" class="btn btn-outline-secondary btn-lg">Learn More</a>
        </div>
      </div>
          ...
          <div class="card-body">
            ...
            <div class="row g-3 mb-4">
              <div class="col-6">
                <div class="stat-card">
                  ...
                  <div class="stat-value" style="font-size:24px;">$<?php echo e(number_format(auth()->user()->balance, 2)); ?></div>
                  <div class="stat-change text-green">↑ +<?php echo e(number_format(auth()->user()->daily_profit, 2)); ?> today</div>
                </div>
              </div>
              <div class="col-6">
                <div class="stat-card">
                  <div class="stat-label"><span class="dot" style="background:var(--green)"></span> Daily Profit</div>
                  <div class="stat-value" style="font-size:24px; color:var(--green)">+$<?php echo e(number_format(auth()->user()->daily_profit, 2)); ?></div>
            ...
            <div style="background:var(--surface2); border:1px solid var(--border); border-radius:10px; padding:16px;">
              <div class="d-flex justify-content-between align-items-center mb-2">
                <span style="font-size:13px; font-weight:600;">Welcome back, <?php echo e(auth()->user()->name); ?> 👋</span>
                <span class="badge bg-success-soft">Active</span>
              </div>
              <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-primary w-100 mt-2">Go to Dashboard →</a>
            </div>
          </div>
        </div>
        <?php else: ?>
        ...
        <div class="card p-2">
          <div class="card-body" style="text-align:center; padding: 40px 24px;">
            ...
            <div class="d-flex flex-column gap-3">
              <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg">Create Free Account</a>
              <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary">Sign In to Dashboard</a>
            </div>
...
<section class="py-5">
  <div class="container">
    <div class="card text-center" style="padding: 48px 24px;">
      ...
      <div>
        <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg px-5">Create Free Account</a>
      </div>
    </div>
  </div>
</section>
...
<?php /**PATH C:\xampp\htdocs\onchain\resources\views/welcome.blade.php ENDPATH**/ ?>