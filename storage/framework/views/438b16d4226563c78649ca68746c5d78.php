...
<div class="container py-4">
  ...
  <div class="row g-2 mb-4">
    ...
    <div class="col-4">
      <button id="tabBtnHistory" class="menu-card w-100" onclick="showTab('history')" style="border:none;cursor:pointer;background:none;">
        <span class="menu-icon">🕐</span>
...
function showTab(tab) {
  ...
  activeBtn.style.background = 'rgba(59,130,246,0.12)';
