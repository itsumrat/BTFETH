      ...
      <div style="overflow-x:auto;">
        <table class="admin-table">
          ...
          <tbody>
            ...
            <tr>
              <td>
                <div style="font-weight:700;color:var(--text);font-size:13px;"><?php echo e(($plan->user->name ?? 'Deleted Customer')); ?></div>
              ...
              <td>
                <div style="display:flex;flex-direction:column;gap:4px;">
                  ...
                  <button class="btn btn-xs btn-success w-100"
                    onclick="openCompleteModal(<?php echo e($plan->id); ?>, '<?php echo e($plan->plan_name); ?>', <?php echo e($plan->cycle_number); ?>, '<?php echo e(($plan->user->name ?? 'Deleted Customer')); ?>', '<?php echo e(number_format($plan->totalExpectedProfit(),2)); ?>', <?php echo e($plan->duration_days); ?>, '<?php echo e($plan->profit_rate); ?>')">
                    ✅ Complete
                  </button>
                  <?php endif; ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\efteth\resources\views/admin/investment-plans.blade.php ENDPATH**/ ?>