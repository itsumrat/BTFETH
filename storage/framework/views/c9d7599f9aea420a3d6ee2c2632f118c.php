...
<div class="container py-5 fade-up">
  ...
  <div class="card text-center" style="padding: 44px 24px;">
    ...
    <div class="d-flex gap-3 justify-content-center flex-wrap">
      <a href="<?php echo e(route('register')); ?>" class="btn btn-primary btn-lg px-5">Get Started</a>
      <a href="<?php echo e(route('plans')); ?>" class="btn btn-outline-secondary btn-lg">View Plans</a>
    </div>
  </div>
...
<?php /**PATH C:\xampp\htdocs\efteth\resources\views/about.blade.php ENDPATH**/ ?>