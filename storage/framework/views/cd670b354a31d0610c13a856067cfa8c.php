...
<div class="admin-layout">
  ...
  <aside class="sidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <a class="sidebar-link <?php echo e(request()->routeIs('admin.plans*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.plans')); ?>">
        <span class="s-icon">📈</span> Investments
      </a>
      <a class="sidebar-link <?php echo e(request()->routeIs('admin.plan-requests*') ? 'active' : ''); ?>" href="<?php echo e(route('admin.plan-requests')); ?>" style="position:relative;">
        <span class="s-icon">📋</span> Plan Requests
        <?php $badge = \App\Models\PlanRequest::unseenCount(); ?>
        <?php if($badge > 0): ?>
          <span style="position:absolute;right:12px;top:50%;transform:translateY(-50%);background:#ef4444;color:#fff;border-radius:50%;width:18px;height:18px;font-size:10px;font-weight:700;display:flex;align-items:center;justify-content:center;line-height:1;"><?php echo e($badge); ?></span>
        <?php endif; ?>
      </a>
...
<?php /**PATH C:\xampp\htdocs\efteth\resources\views/layouts/admin.blade.php ENDPATH**/ ?>