  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navMenu">
      <ul class="navbar-nav ms-auto align-items-lg-center gap-1">
        ...
        <li class="nav-item"><a class="nav-link active" href="<?php echo e(route('plans')); ?>">Plans</a></li>
        <li class="nav-item"><a class="nav-link" href="<?php echo e(route('about')); ?>">About</a></li>
        <li class="nav-item ms-lg-2"><a class="btn btn-outline-secondary btn-sm" href="<?php echo e(route('login')); ?>">Sign Out</a></li>
      </ul>
    </div>
  </div>
</nav>
...
<div style="background:rgba(34,197,94,0.12);border:1px solid rgba(34,197,94,0.3);color:#22c55e;border-radius:10px;padding:14px 20px;margin:16px auto;max-width:1200px;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:space-between;"><span>✅ <?php echo e(session('success')); ?></span><button class="alert-close" onclick="dismissAlert(this)" title="Dismiss">&times;</button></div>
<?php endif; ?>
<?php if(session('error')): ?>
<div style="background:rgba(239,68,68,0.12);border:1px solid rgba(239,68,68,0.3);color:#f87171;border-radius:10px;padding:14px 20px;margin:16px auto;max-width:1200px;font-size:14px;font-weight:600;display:flex;align-items:center;justify-content:space-between;"><span>⚠️ <?php echo e(session('error')); ?></span><button class="alert-close" onclick="dismissAlert(this)" title="Dismiss">&times;</button></div>
<?php endif; ?>
  ...
  <div class="row g-4 mb-5">
    ...
    <div class="col-sm-6 col-lg-3">
      <div class="plan-card">
        ...
        <?php else: ?>
        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-primary w-100 mt-3" style="font-size:13px;padding:9px;">
          Sign In to Select
        </a>
        <?php endif; ?>
      </div>
...
<div class="modal fade" id="planRequestModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content" style="background:var(--surface);border:1px solid var(--border);">
      ...
      <form method="POST" action="<?php echo e(route('plan-request.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <div class="modal-body" style="background:var(--surface);">
          ...
          <div style="background:rgba(34,197,94,0.07);border:1px solid rgba(34,197,94,0.2);border-radius:8px;padding:10px 14px;margin-bottom:14px;display:flex;justify-content:space-between;align-items:center;">
            ...
            <span style="font-size:14px;font-weight:700;color:#22c55e;font-family:'JetBrains Mono',monospace;">$<?php echo e(number_format(auth()->user()->balance, 2)); ?> USDT</span>
          </div>
          <?php endif; ?>
...
<?php /**PATH E:\xampp\htdocs\efteth\resources\views/plans.blade.php ENDPATH**/ ?>