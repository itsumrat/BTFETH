            ...
            <tr>
              <td>
                <div style="display:flex;align-items:center;gap:10px;">
                  <div class="avatar"><?php echo e($txn->user ? $txn->user->initials() : '?'); ?></div>
                  <div>
                    <div style="font-weight:700;font-size:14px;color:var(--text);"><?php echo e($txn->user->name ?? 'Deleted Customer'); ?></div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp\htdocs\efteth\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>