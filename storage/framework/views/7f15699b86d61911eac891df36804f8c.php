  ...
  <div class="cust-topbar-right">
    <div class="dropdown">
      ...
      <ul class="dropdown-menu dropdown-menu-end cust-dropdown">
        <li><a class="dropdown-item cust-drop-item" href="<?php echo e(route('dashboard')); ?>">🏠 &nbsp;Dashboard</a></li>
        <li><a class="dropdown-item cust-drop-item" href="<?php echo e(route('profile.edit')); ?>">👤 &nbsp;Edit Profile</a></li>
        <li><a class="dropdown-item cust-drop-item" href="<?php echo e(route('password.change')); ?>">🔑 &nbsp;Change Password</a></li>
    ...
    <div class="card-body" style="padding:28px;">
      ...
      <div class="text-center mb-4">
        <div id="avatarPreviewWrap" style="position:relative;display:inline-block;">
          <?php if($user->avatar): ?>
            <img id="avatarPreview" src="<?php echo e(asset('avatars/' . $user->avatar)); ?>"
      ...
      <form method="POST" action="<?php echo e(route('profile.update')); ?>" enctype="multipart/form-data">
        ...
        <div class="mb-4">
          ...
          <input type="email" class="form-control" value="<?php echo e($user->email); ?>" disabled style="opacity:0.5;cursor:not-allowed;"/>
        ...
        <a href="<?php echo e(route('dashboard')); ?>" class="btn btn-outline-secondary w-100 mt-2">← Back to Dashboard</a>
      </form>
...
<?php /**PATH C:\xampp\htdocs\onchain\resources\views/profile/edit.blade.php ENDPATH**/ ?>