  ...
  <div class="row g-3 mb-4">
      ...
      <div class="balance-card">
        <div class="balance-card-top">
          <div>
            ...
            <div class="balance-amount">${{ number_format($user->balance, 2) }} <span class="balance-currency">USDT</span></div>
          </div>
    ...
    <div class="col-6">
      <div class="stat-card">
        ...
        <div class="stat-value text-green">+${{ number_format($user->daily_profit, 2) }}</div>
